...
<div>
  <header>      
    <div id="logo"></div>
    <div id="app_title">Desde .. <a id="api_link" href="https://developers.google.com/">Desde Google Developers</a></div>
  </header>
  <table cellspacing="10">
    <tr><td>&nbsp;</td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><td><div class="label">Modelo:</div></td><td colspan="2">
      <select id="model_id" onchange="change_model(this)">
        ...
        <%
          ...
          String selectedModelName = (String) request.getAttribute("selected_model_name");
          ...
          // Recorrer los datos de los modelos de forma iterativa (esto se muestra en el menu)
          for (Map.Entry entry : models.entrySet()) {
            ...
            // Marcar el modelo seleccionado para generar los elemento de ingreso de información
      ...
      if (modelName.equals(selectedModelName)) {
          ...
          // Mostrar los elementos de ingreso según el modelo seleccionado
    ...
    <tr><td></td><td>
      <a class="atd-button atd-search-button" style="margin-left: 0px; margin-top: 10px;" onclick="predict()">Predecir</a>
      </td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><td><div class="label">Resultados:</div></td><td><b><div id="prediction_result"></div></b><a href='' id="switch_chart_link"></a></td></tr>
    <tr><td>&nbsp;</td><td>
